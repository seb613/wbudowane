...
void task1(void *pdata)
{
    ...
    while (1)
    {
        printf("state = %d\n", state);
        printf("pstate = %d\n", pstate);
        swstate = IORD(SLIDER_SWITCHES_BASE, 0);
        ...
        if (state == STATE_RED)
        {
            IOWR(HEX3_HEX0_BASE, 0, ONE);
            IOWR(LEDS_BASE, 0, LED0 | LED6); // czerw1 ziel2
            IOWR(HEX3_HEX0_BASE, 2, THREE);
...
void task2(void *pdata) // read orange
{
    while (1)
    {
        ...
        if (*state == 2)
        {
            IOWR(HEX3_HEX0_BASE, 0, TWO);
            IOWR(LEDS_BASE, 0, LED0 | LED1 | LED5); // czerw1 pom1 pom2
            IOWR(HEX3_HEX0_BASE, 2, FOUR);
        };
...
void task3(void *pdata)
{
    while (1)
    {
        ...
        if (*state == 3)
        {
            IOWR(HEX3_HEX0_BASE, 0, THREE);
            IOWR(LEDS_BASE, 0, LED2 | LED4); // ziel1 czer2
            IOWR(HEX3_HEX0_BASE, 2, ONE);
        };
        OSTimeDlyHMSM(0, 0, 0, 100);
    }
}
...
void task4(void *pdata)
{
    while (1)
    {
        ...
        if (*state == 4)
        {
            IOWR(HEX3_HEX0_BASE, 0, FOUR);
            IOWR(LEDS_BASE, 0, LED1 | LED4 | LED5); // pom1 pom2 czerw2
            IOWR(HEX3_HEX0_BASE, 2, TWO);
        };
        OSTimeDlyHMSM(0, 0, 0, 100);
    }
}
...
void task5(void *pdata)
{
    while (1)
    {
        ...
        if (*state == 5)
        {
            IOWR(HEX3_HEX0_BASE, 0, FIVE);
            IOWR(LEDS_BASE, 0, LED3 | LED7);
            IOWR(HEX3_HEX0_BASE, 2, FIVE);
        };
        OSTimeDlyHMSM(0, 0, 0, 100);
    }
}
...
void task6(void *pdata)
{
    while (1)
    {
        ...
        if (*state == 6)
        {
            IOWR(HEX3_HEX0_BASE, 0, SIX);
            IOWR(HEX3_HEX0_BASE, 2, SIX);
            IOWR(LEDS_BASE, 0, LED0 | LED6); // czerw1 ziel2
        };
        OSTimeDlyHMSM(0, 0, 0, 100);
    }
...
void task7(void *pdata)
{
    while (1)
    {
        ...
        if (*state == 7)
        {
            IOWR(HEX3_HEX0_BASE, 0, SEVEN);
            IOWR(HEX3_HEX0_BASE, 2, SEVEN);
            IOWR(LEDS_BASE, 0, 0);
        };
        OSTimeDlyHMSM(0, 0, 0, 100);
    }
